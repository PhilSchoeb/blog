...
Cependant, il est important de rappeler que dans la milestone 1 nous avions utilisé des méthodes pour nous débarrasser au préalable de certaines données aberrantes = inclure ce qu'on a fait.
