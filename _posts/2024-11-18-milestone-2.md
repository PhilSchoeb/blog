...
Pour les données de validation des série éliminatoire, on peut voir que les performances des modèles présentent des similitudes globales avec celles observées sur l’ensemble de test de la saison régulière, mais avec quelques différences notables. 
